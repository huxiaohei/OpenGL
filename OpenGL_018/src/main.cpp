/*================================================================
* Description 进入3D--坐标系统--多个立方体
* Email huliuworld@yahoo.com
* Created on Wed May 01 2019 18:0:12
* Copyright (c) 2019 刘虎
================================================================*/
...
int main() {
    GLFWwindow *window = createWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "进入3D--坐标系统--多个立方体");
    if (window == NULL) {
