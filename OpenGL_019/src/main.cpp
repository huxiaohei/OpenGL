/*================================================================
* Description 进入3D--摄像机--旋转
* Email huliuworld@yahoo.com
* Created on Wed May 01 2019 19:55:22
* Copyright (c) 2019 刘虎
================================================================*/
...
int main() {
    GLFWwindow *window = createWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "摄像机");
    if (window == NULL) {
...
int draw(GLFWwindow *window) {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        view = glm::lookAt(glm::vec3(cameraX, 0.0f, cameraZ), // 摄像机位置
                           glm::vec3(0.0f, 0.0f, 0.0f),       // 目标位置
                           glm::vec3(0.0f, 1.0f, 0.0f));      // 上向量
#else
        view = glm::lookAt(glm::vec3(0.0f, 0.0f, 6.0f),  // 摄像机位置
                           glm::vec3(0.0f, 0.0f, 0.0f),  // 目标位置
                           glm::vec3(0.0f, 1.0f, 0.0f)); // 上向量
#endif
